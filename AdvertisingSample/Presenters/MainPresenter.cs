...
namespace AdvertisingSample.Presenters
{
    /// <summary>
    /// メイン Presenter
    /// </summary>
    public class MainPresenter : IPresenter
    {
        ...
        /// <summary>
        /// このアプリについての設定ポップアップを表示する
        /// </summary>
        public void ShowAboutFlyout()
        {
            new AboutFlyout().ShowIndependent();
        }
